...
def iterate_applicants():
    query = "SELECT * FROM applicant_2500"
...
def count_medical_students():
    query = """SELECT COUNT(*) FROM applicant_2500
...
def get_transcript_ids():
    query = """SELECT transcript_id FROM applicant_2500 WHERE gender = 'male' AND year_of_graduation = 2010
...
def get_applicant_ids():
    query = """ SELECT applicant_id FROM applicant_2500
