...
def iterate_applicants():
    ...
    query = """MATCH (a:applicant_2500) RETURN a """
...
def count_medical_students():
    ...
    query = """MATCH (a:applicant_2500) WHERE a.degree = 'Medical' AND a.gender = 'Female' AND a.nationality = 'USA'
...
def get_transcript_ids():
    ...
    query = """MATCH (a:applicant_2500) WHERE a.gender = 'male'AND a.year_of_graduation = 2010
...
def get_applicant_ids():
    ...
    query = """MATCH (a:applicant_2500) WHERE a.application_status = 'rejected'AND a.institution_name = 'messina'
