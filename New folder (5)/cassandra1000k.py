...
def iterate_applicants():
    query = "SELECT * FROM applicant_1000"
...
def count_medical_students():
    query = """SELECT COUNT(*) FROM applicant_1000
...
def get_transcript_ids():
    query = """SELECT transcript_id FROM applicant_1000 WHERE gender = 'male' AND year_of_graduation = 2010
...
def get_applicant_ids():
    query = """ SELECT applicant_id FROM applicant_1000
